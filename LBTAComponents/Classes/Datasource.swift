...
open class Datasource: NSObject {
    ...
    @objc open func item(_ indexPath: IndexPath) -> Any? {
        return objects?[indexPath.item]
    }
    
    ///If your headers need a special item, return it here.
    @objc open func headerItem(_ section: Int) -> Any? {
        return nil
    }
    
    ///If your footers need a special item, return it here
    @objc open func footerItem(_ section: Int) -> Any? {
        return nil
    }
