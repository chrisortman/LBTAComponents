...
open class DatasourceCell: UICollectionViewCell {
    ...
    @objc open var datasourceItem: Any?
    @objc open weak var controller: DatasourceController?
    @objc open weak var collectionView: DatasourceCollectionView?

    
    @objc public let separatorLineView: UIView = {
        let lineView = UIView()
